...
<template>
  ...
  >
    <div>
      ...
      <Link :href="route('home')">
        <div class="hover:text-blue-500">Halaman</div>
      </Link>
      <Link :href="route('produk')">
        <div class="hover:text-blue-500">Produk</div>
      </Link>
  ...
  <div class="flex justify-center text-xs pb-4 bg-base-300 text-base-content">
